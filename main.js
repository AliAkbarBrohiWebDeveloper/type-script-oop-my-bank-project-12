...
console.log(chalk.blue.bold("\n\t Welcome To Ali Akbar Brohi OOP My Bank\n\t"));
...
// create customers
const customers = [
    new Customer("Ali", "Akbar", "Male", 18, 124651234, accounts[0]),
    new Customer("Muhammad", "Khan", "Male", 45, 768654334, accounts[1]),
    new Customer("Zubair", "Ahmad", "Male", 23, 2345678901, accounts[2]),
];
